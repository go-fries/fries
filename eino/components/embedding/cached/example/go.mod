...
require (
	github.com/cloudwego/eino v0.7.16
	github.com/go-fries/fries/eino/components/embedding/cached/cacher/redis/v3 v3.11.0
	github.com/go-fries/fries/eino/components/embedding/cached/v3 v3.11.0
