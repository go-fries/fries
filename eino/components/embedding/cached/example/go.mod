...
require (
	github.com/cloudwego/eino v0.4.2
	github.com/go-fries/fries/eino/components/embedding/cached/cacher/redis/v3 v3.8.0
	github.com/go-fries/fries/eino/components/embedding/cached/v3 v3.8.0
...
require (
	...
	github.com/go-fries/fries/codec/sonic/v3 v3.8.0 // indirect
