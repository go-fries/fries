...
require (
	github.com/go-fries/fries/codec/sonic/v4 v4.2.0
	github.com/go-fries/fries/codec/v4 v4.2.0
	github.com/go-fries/fries/eino/components/embedding/cached/v4 v4.2.0
...
require (
	...
	github.com/cloudwego/eino v0.9.20 // indirect
