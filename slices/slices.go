...
// KeyBy returns a new map containing items in s keyed by the value returned by
// fn.
//
//	KeyBy([]string{"apple", "banana"}, func(s string) string {
//		return s[:1]
...
// KeyByN returns a new map containing items in s keyed by the value returned by
// fn. The current index is passed to fn as the second argument.
//
//	KeyByN([]string{"apple", "banana"}, func(s string, i int) int {
//		return i
...
// CountByN returns a new map containing item counts grouped by the key returned
// by fn. The current index is passed to fn as the second argument.
//
//	CountByN([]int{1, 2, 3, 4}, func(_, i int) string {
//		if i < 2 {
//			return "first"
//		}
//		return "last"
