...
require (
	...
	buf.build/gen/go/bufbuild/bufplugin/protocolbuffers/go v1.36.12-20250718181942-e35f9b667443.1 // indirect
	...
	mvdan.cc/unparam v0.0.0-20260813220802-35700344e60f // indirect
