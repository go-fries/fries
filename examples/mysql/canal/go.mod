...
require (
	github.com/go-fries/fries/mysql/canal/positioner/redis/v3 v3.6.0
	github.com/go-fries/fries/mysql/canal/v3 v3.6.0
)
...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20250606085706-9f38fcae009c // indirect
