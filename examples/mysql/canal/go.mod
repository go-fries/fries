...
require (
	github.com/go-fries/fries/mysql/canal/positioner/redis/v3 v3.1.0
	github.com/go-fries/fries/mysql/canal/v3 v3.1.0
)
...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20250423103223-6bd86d5dec59 // indirect
