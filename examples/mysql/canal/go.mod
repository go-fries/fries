...
require (
	github.com/go-fries/fries/mysql/canal/positioner/redis/v3 v3.15.0
	github.com/go-fries/fries/mysql/canal/v3 v3.15.0
)
...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20260630101339-693e52cd51bd // indirect
