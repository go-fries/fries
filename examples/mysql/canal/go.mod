...
require (
	github.com/go-fries/fries/mysql/canal/positioner/redis/v3 v3.13.0
	github.com/go-fries/fries/mysql/canal/v3 v3.13.0
)
...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20260601200904-551d10a6525a // indirect
