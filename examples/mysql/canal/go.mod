...
require (
	github.com/go-fries/fries/mysql/canal/positioner/redis/v3 v3.10.0
	github.com/go-fries/fries/mysql/canal/v3 v3.10.0
)
...
require (
	...
	github.com/go-fries/fries/codec/json/v3 v3.10.0 // indirect
