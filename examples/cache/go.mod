...
require (
	github.com/go-fries/fries/cache/redis/v3 v3.15.0
	github.com/go-fries/fries/cache/v3 v3.15.0
	github.com/redis/go-redis/v9 v9.21.0
)

require (
	github.com/cespare/xxhash/v2 v2.3.0 // indirect
	github.com/go-fries/fries/codec/json/v3 v3.15.0 // indirect
	github.com/go-fries/fries/codec/v3 v3.15.0 // indirect
	github.com/go-fries/fries/locker/redis/v3 v3.15.0 // indirect
	github.com/go-fries/fries/locker/v3 v3.15.0 // indirect
