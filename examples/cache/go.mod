...
require (
	github.com/go-fries/fries/cache/redis/v3 v3.2.0
	github.com/go-fries/fries/cache/v3 v3.2.0
...
require (
	...
	github.com/go-fries/fries/locker/redis/v3 v3.2.0 // indirect
	github.com/go-fries/fries/locker/v3 v3.2.0 // indirect
