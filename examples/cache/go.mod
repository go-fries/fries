...
require (
	github.com/go-fries/fries/cache/redis/v3 v3.10.0
...
require (
	...
	github.com/go-fries/fries/locker/redis/v3 v3.10.0 // indirect
	github.com/go-fries/fries/locker/v3 v3.10.0 // indirect
