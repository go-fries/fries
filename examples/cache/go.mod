...
require (
	github.com/go-fries/fries/cache/redis/v3 v3.9.2
...
require (
	...
	github.com/go-fries/fries/locker/redis/v3 v3.9.2 // indirect
	github.com/go-fries/fries/locker/v3 v3.9.2 // indirect
