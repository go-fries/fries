...
require (
	github.com/go-fries/fries/queue/adapter/memory/v3 v3.15.0
	github.com/go-fries/fries/queue/v3 v3.15.0
)

require github.com/go-fries/fries/codec/v3 v3.15.0 // indirect
