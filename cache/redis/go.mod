...
require (
	github.com/go-fries/fries/cache/v4 v4.2.0
	github.com/go-fries/fries/codec/json/v4 v4.2.0
	github.com/go-fries/fries/codec/v4 v4.2.0
	github.com/go-fries/fries/locker/redis/v4 v4.2.0
	github.com/go-fries/fries/locker/v4 v4.2.0
