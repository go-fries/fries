...
| Event | [`event`](https://pkg.go.dev/github.com/go-fries/fries/event/v4)<br>[`event/middleware/recovery`](https://pkg.go.dev/github.com/go-fries/fries/event/middleware/recovery/v4)<br>[`eventbus`](https://pkg.go.dev/github.com/go-fries/fries/eventbus/v4) | Typed event dispatching, recovery middleware, and an in-process event bus. |
...
| Foundation | [`foundation`](https://pkg.go.dev/github.com/go-fries/fries/foundation/v4) | An application kernel and service-provider lifecycle. |
